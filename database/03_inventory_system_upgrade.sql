...
-- ============================================
-- VISTA: Items de pedido con modificaciones para ticket de cocina
-- ============================================
-- El agente de impresión puede usar esta vista para imprimir en el ticket
-- las modificaciones (sin X, extra Y, +N unidad) por ítem.
--

DROP VIEW IF EXISTS vista_items_ticket_cocina;
CREATE VIEW vista_items_ticket_cocina AS
SELECT
  ip.pedido_id,
...
COMMENT ON VIEW vista_items_ticket_cocina IS 'Items de pedido con texto de modificaciones para ticket de cocina (sin X, extra Y). Consultar por pedido_id.';
...
BEGIN
  ...
  RAISE NOTICE '  ✅ Vista vista_items_ticket_cocina (items + modificaciones para ticket)';
